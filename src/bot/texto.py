...
txt_coex = """A Coordenação de Extensão (COEX) tem como objetivo central garantir a interação
entre o IFRN e a comunidade externa.\n"""
txt_coex += """\nCom isso, busca garantir a divulgação, o desenvolvimento de novas tecnologias e a 
manutenção da relação com o mundo do trabalho para que desta forma seja efetiva a qualidade da formação 
...
{txt_comum}\n
clique no link para ver um vídeo tutorial:
https://www.youtube.com/watch?v=ABqkjmbtLp8
